module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      'dist': {
        options: {
          banner: grunt.file.read('src/css/wrapper.start.js'),
        },
        src: [
          'dist/css/select2.js',
          'src/css/wrapper.end.js'
        ],
        dest: 'dist/css/select2.js'
      },
      'dist.full': {
        options: {
          banner: grunt.file.read('src/css/wrapper.start.js'),
        ...
        src: [
          'dist/css/select2.full.js',
          'src/css/wrapper.end.js'
        ],
        dest: 'dist/css/select2.full.js'
      }
    },
    ...
    uglify: {
      'dist': {
        src: 'dist/css/select2.js',
        dest: 'dist/css/select2.min.js',
        options: {
          banner: minifiedBanner
        }
      },
      'dist.full': {
        src: 'dist/css/select2.full.js',
        dest: 'dist/css/select2.full.min.js',
        options: {
          banner: minifiedBanner
        }
      }
    ...
    requirejs: {
      'dist': {
        options: {
          ...
          wrap: {
            startFile: 'src/css/banner.start.js',
            endFile: 'src/css/banner.end.js'
          }
        }
      },
      'dist.full': {
      ...
      'i18n': {
        options: {
          baseUrl: 'src/css/select2/i18n',
          dir: 'dist/css/i18n',
          paths: i18nPaths,
          modules: i18nModules,
          namespace: 'S2',
          wrap: {
            start: minifiedBanner + grunt.file.read('src/css/banner.start.js'),
            end: grunt.file.read('src/css/banner.end.js')
          }
        }
      }
    },
